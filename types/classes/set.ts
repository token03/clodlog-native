...
export class Set implements ISet {
  ...
  constructor(id: string, images: ISetImage, legalities: ILegality, name: string, printedTotal: number, ptcgoCode: string, releaseDate: string, series: string, total: number, updatedAt: string) {
    this.id = id;
    this.images = images;
