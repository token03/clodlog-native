...
import { GridColumnSlider, SettingSection, CurrencySelector } from '@/components/Setting';
            ...
            <View flex={1} padding='$6'>
                <YStack gap='$5'>
                    <SettingSection title='Card Details'>
                        ...
                        />
                        <XStack gap={'$3'}>
                            <Label {...labelProps}>Price Type:</Label>
                            <SelectItem
                                ...
                                onValueChange={value =>
                                    updateSetting('gridPriceType', value as PriceType)
                                }
                                size={'$3'}
                                label={'Price Type:'}
                            />
                        ...
                        <XStack gap={'$3'}>
                            <Label {...labelProps}>Holographic:</Label>
                            <Switch
                                checked={settings.holographic}
                                onCheckedChange={value => updateSetting('holographic', value)}
                                size={'$3'}
                                alignSelf={'center'}
                            >
                    ...
                    <SettingSection title='Card Grid'>
                        ...
                        <XStack>
                            <Label {...labelProps}>Sort Direction:</Label>
                            <SelectItem
                                width={'70%'}
                                size={'$3'}
                        ...
                        <XStack gap={'$3'}>
                            <Label {...labelProps}>Display Price:</Label>
                            <Switch
                                checked={settings.alwaysDisplayPrice}
                                onCheckedChange={value =>
                                    updateSetting('alwaysDisplayPrice', value)
                                }
                                size={'$3'}
                                alignSelf={'center'}
                            >
