...
export function DeleteWishlistAlertDialogButton({
  Wishlist,
  afterDelete,
  ...props
}: PopoverProps & { Wishlist: Wishlist; afterDelete?: (id: string) => void }) {
        ...
        >
          <YStack gap={'$3'}>
            ...
            <AlertDialog.Description>
              <YStack>
                <Paragraph size={'$3'}>Are you sure you want to delete this wishlist?</Paragraph>
                <Paragraph size={'$3'}>
