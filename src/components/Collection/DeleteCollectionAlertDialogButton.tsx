import { AlertDialog, Button, Paragraph, PopoverProps, XStack, YStack } from 'tamagui';
import { Edit3, Plus, Trash2, X } from '@tamagui/lucide-icons';
import { useCollections } from '@/contexts/CollectionContext';
import { Collection } from '@/types/interfaces/collection';

export function DeleteCollectionAlertDialogButton({
  Collection,
  afterDelete,
}: PopoverProps & { Collection: Collection; afterDelete?: (id: string) => void }) {
        ...
        >
          <YStack gap={'$3'}>
            ...
            <AlertDialog.Description>
              <YStack>
                <Paragraph size={'$3'}>Are you sure you want to delete this collection?</Paragraph>
                <Paragraph size={'$3'}>
